...
For a proposed modification, read `.harness/references/change-control.md`. Do not overwrite an approved requirement. Create a `CR-###`, compare before and after, analyze schedule/deliverable/risk impact, and ask for conversational approval. Mark the old requirement superseded only after approval.
